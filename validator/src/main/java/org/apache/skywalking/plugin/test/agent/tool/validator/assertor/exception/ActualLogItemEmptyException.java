...
public class ActualLogItemEmptyException extends AssertFailedException {

    private final LogItem expected;

    public ActualLogItemEmptyException(LogItem expected) {
        this.expected = expected;
    }

    @Override
    public String getCauseMessage() {
        return String.format("ActualLogItemEmptyException\nexpected: %s\nactual: %s", expected, "Empty");
    }
}
