...
public class LogItemNotFoundException extends AssertFailedException {
    private final String serviceName;

    public LogItemNotFoundException(String serviceName) {
        this.serviceName = serviceName;
    }

    @Override
    public String getCauseMessage() {
        return String.format("LogItemNotFoundException\nexpected: %s\nactual: %s", serviceName, "Not Found");
    }
}
