...
public class MeterItemNotFoundException extends AssertFailedException {
    private final String serviceName;

    public MeterItemNotFoundException(String serviceName) {
        this.serviceName = serviceName;
    }

    @Override
    public String getCauseMessage() {
        return String.format("MeterItemNotFoundException\nexpected: %s\nactual: %s", serviceName, "Not Found");
    }
}
