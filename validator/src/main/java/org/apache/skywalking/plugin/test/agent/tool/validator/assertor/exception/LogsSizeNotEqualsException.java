...
public class LogsSizeNotEqualsException extends AssertFailedException {
    private final String serviceName;
    private final String expected;
    private final String actual;

    public LogsSizeNotEqualsException(String serviceName, String expected, String actual) {
